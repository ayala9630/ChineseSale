        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donors_Addresses_CompanyAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LotteriesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonorLottery", x => new { x.CardsId, x.LotteriesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DonorLottery_Lotteries_LotteriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Gifts_Lotteries_LotteryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackageCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackageCarts_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PackageCarts_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CardCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CardCarts_Gifts_GiftId",
                        column: x => x.GiftId,
                        principalTable: "Gifts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardCarts_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardCarts_GiftId",
                table: "CardCarts",
                column: "GiftId");

            migrationBuilder.CreateIndex(
                name: "IX_CardCarts_UserId",
                table: "CardCarts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonorLottery_LotteriesId",
                table: "DonorLottery",
                column: "LotteriesId");

            migrationBuilder.CreateIndex(
                name: "IX_Donors_CompanyAddressId",
                table: "Donors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gifts_LotteryId",
                table: "Gifts",
                column: "LotteryId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageCarts_PackageId",
                table: "PackageCarts",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_PackageCarts_UserId",
                table: "PackageCarts",
                column: "UserId");
